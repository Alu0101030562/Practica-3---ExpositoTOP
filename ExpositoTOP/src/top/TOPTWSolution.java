...
/**
 * @brief Clase TOPTWSolution, contiene los metodos de la clase TOPTWSolution
 */
public class TOPTWSolution {
    ...
    /**
     * @brief metodo a la solucion TOPTW
    ...
    /**
     * @brief metodo de inicializacion a la solucion
     */

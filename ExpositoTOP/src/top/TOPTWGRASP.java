...
/**
 * @brief Clase TOPTWGRASP, contiene los metodos de la clase TOPTWGRASP
 */
public class TOPTWGRASP {
 public static double NO_EVALUATED = -1.0;
    ...
    /**
     * @brief metodo GRASP
     * @param maxIteration - numero de iteraciones maximas
     * @param maxSizeRCL - numero maximo de RCL
     */
    ...
    public int aleatorySelectionRCL(int maxTRCL) {
       ...
       int low = 0;
       int high = maxTRCL;
       int posSelected = aleatorio.nextInt(high-low) + low;
       return posSelected;
    }

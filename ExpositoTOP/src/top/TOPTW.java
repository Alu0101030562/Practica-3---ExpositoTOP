...
/**
 * @brief Clase TOPTW, contiene los metodos de la clase TOPTW
 */
public class TOPTW {
    private int nodes;
    private double[] x;
    ...
    private double[][] distanceMatrix; /// Variable double con la distancia de la matriz
    
    /**
    * @brief metodo que instancia maxRoutes y vehicles
    * @param nodes - nodos introducidos
    * @param routes - rutas introducidas
    */
    ...
    /**
     * @brief Metodo que indica si el valor introducido es mayor que los nodos.
     * @param a - numero de nodos.
     * @return booleano a true si es cierto, en caso contrario false
     */
    ...
    /**
     * @brief Metodo que obtiene la distancia
     * @param route - valor con la ruta
    ...
    /**
     * @brief Metodo que obtiene la distancia de la matriz
     * @return el valor de la distancia de la matriz
     */
    ...
    /**
     * @brief Metodo que obtiene el tiempo maximo por ruta
     * @return el valor maximo de la ruta
     */
    ...
    /**
     * @brief Metodo que reemplaza el tiempo maximo por ruta
     * @param maxTimePerRoute - tiempo maximo por ruta
     */
    ...
    /**
     * @brief Metodo que obtiene la maxima ruta
     * @return la ruta maxima
     */
    ...
    /**
     * @brief Metodo que reemplaza la ruta maxima
     * @param maxRoutes - ruta maxima
     */
